    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_description', models.CharField(blank=True, max_length=255, verbose_name='Task Description')),
                ('date_time_due', models.DateTimeField(verbose_name='Date/Time Due')),
                ('text_input_required', models.BooleanField(default=False, verbose_name='Text Input Required')),
                ('completion_text', models.CharField(blank=True, max_length=255, verbose_name='Completion Text')),
                ('task_completion', models.BooleanField(default=False, verbose_name='Task Completed')),
                ('date_time_completion', models.DateTimeField(blank=True, verbose_name='Date/Time Completed')),
                ('staff_netid', models.CharField(blank=True, max_length=255, verbose_name='Staff NetID')),
                ('recurrence_pattern', models.CharField(blank=True, choices=[(None, 'None'), ('daily', 'Daily'), ('weekly', 'Weekly'), ('monthly', 'Monthly'), ('yearly', 'Yearly')], max_length=20, verbose_name='Recurrence Pattern')),
            ],
        ),
        migrations.CreateModel(
            name='UrecFacility',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relation', models.CharField(default='wip', max_length=255, verbose_name='Relation to Witnesses')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('ureccontact_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='urec_app.ureccontact')),
                ('relation', models.CharField(default='wip', max_length=255, verbose_name='Relation to Patient')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='urecreport',
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='urec_app.ureclocation', verbose_name='Facility / Location'),
        ),
        migrations.AddField(
            model_name='ureclocation',
            name='facility',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='urec_app.urecfacility'),
        ),
        migrations.AddField(
            model_name='count',
            name='location',
