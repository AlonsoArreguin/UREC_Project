# Generated by Django 4.2.7 on 2024-02-21 02:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_time_submission', models.DateTimeField(auto_now_add=True)),
                ('severity', models.CharField(choices=[('Minor', 'Minor'), ('Moderate', 'Moderate')], max_length=255)),
                ('ems_called', models.BooleanField(verbose_name='EMS / Fire Called')),
                ('police_called', models.BooleanField(verbose_name='Police Called')),
                ('staff_netid', models.CharField(max_length=255)),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='urec_app.ureclocation')),
            ],
        ),
        migrations.CreateModel(
            name='IncidentReport',
